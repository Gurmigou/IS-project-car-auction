...
} from "./components/user-approved-auctions/user-approved-auctions-card/user-approved-auctions-card.component";
...
@NgModule({
  ...
  providers: [HttpParams, {provide: HTTP_INTERCEPTORS, useClass: AuthInterceptor, multi: true},],
